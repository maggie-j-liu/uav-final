...
if __name__ == "__main__":
    ...
    for i in range(L):
        ...
        u_lr, last_time_lr, last_error_lr, ITerm_lr = tello_pid(PX_MOVEMENTS[0], last_time_lr, last_error_lr, ITerm_lr)
        u_fb, last_time_fb, last_error_fb, ITerm_fb = tello_pid(PX_MOVEMENTS[1], last_time_fb, last_error_fb, ITerm_fb)
        u_ud, last_time_ud, last_error_ud, ITerm_ud = tello_pid(PX_MOVEMENTS[2], last_time_ud, last_error_ud, ITerm_ud)
